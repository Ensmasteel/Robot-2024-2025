...
void MoveProfilesSetup::setup(){
    ...
    //get(standard,true)->set(34000.0 , 0.01 , 0.01 , 0.01 , 0.003 , 0.03 , 0.1 , 0.2);           //translation
    
    get(standard,true)->set(34000.0 , 0.01 , 0.01 , 0.01 , 0.003 , 0.03 , 0.8 , 0.9);           //translation
    get(standard,false)->set(4000 , 0.01 , 0.015 , 0.05 , 0.01 , 20*0.017 , 0.2 , 90*0.017);   //rotation
