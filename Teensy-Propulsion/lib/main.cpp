...
SequenceManager* brain_numeriexplore2;
...
void setup() {
    ...
    Sequence Brain_Numeriexplore2(
        {
            new StaticAction(OPEN_CLAWS,true),
            new StaticAction(LOWER_CLAWS,true),

            new StaticAction(START_MAGNET,true),
            new MoveAction(VectorOriented( -0.30f, 0.0f,  0.0f), false, true, true, true),
            new MoveAction(VectorOriented( 0.0f,  0.0f,  0.0f), false, false, true, true),
            new MoveAction(VectorOriented( 0.30f,  0.0f,  0.0f), false, false, true, true),
            new StaticAction(CLOSE_CLAWS),
            new MoveAction(VectorOriented( 0.0f,  0.0f,  0.0f), false, true, true, true),
            new StaticAction(SHUTDOWN_MAGNET,true),
            new StaticAction(RAISE_CLAWS),
            new MoveAction(VectorOriented( 0.13f,  0.0f,  0.0f), false, false, true, true),
            new MoveAction(VectorOriented( 0.13f,  0.0f,  -PI), true, false, true, true),
            new MoveAction(VectorOriented( -0.04f,  0.0f,  -PI), false, false, true, true),
            new StaticAction(OPEN_CLAWS),
            new MoveAction(VectorOriented( 0.13f,  0.0f,  -PI), false, true, true, true),
            new StaticAction(LOWER_CLAWS)
        }
    );
    brain_numeriexplore = new SequenceManager({Brain_Numeriexplore});
    brain_numeriexplore2 = new SequenceManager({Brain_Numeriexplore2}); 
